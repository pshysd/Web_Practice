 ...
 * Generated at: 2022-10-18 02:37:14 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1666060518903L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	\r\n");
      out.write("		");
 // 로그인한 사용자의 정보를 sesion에 담았기 때문에 // 이 웹 애플리케이션의 어디서든지 해당 키 값을 제시해서 로그인한 사용자의 정보를 가져올 수 있음 Member
			loginUser=(Member) session.getAttribute("loginUser"); // System.out.println(loginUser); // 로그인 전 menubar.jsp
			로딩 시 : null // 로그인 후 menubar.jsp 로딩 시 : 로그인한 회원의 정보가 담긴 Member 객체 String
			contextPath=request.getContextPath(); // 성공 시 알람 문구 또한 session에 담았기 때문에 // session으로부터 뽑기 String
 ...
 if (loginUser==null) { 
      ...
      out.write("\r\n");
      out.write("		<!-- \r\n");
      out.write("			현재 나의 주소 : http://localhost:8888/jsp/enrollForm.me\r\n");
      out.write("			내가 요청을 보내고자 하는 주소 : http://localhost:8888/jsp/insert.me\r\n");
      out.write("			\r\n");
      out.write("			절대경로 : /jsp/insert.me\r\n");
      out.write("			상대경로 : insert.me\r\n");
      out.write("		-->\r\n");
      ...
      out.write("                        <!-- 중복확인 나중에 AJAX 라는 기술을 배우고 할 것 -->\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      ...
      out.write("                        <!-- 서버로 넘기지는 않을것이기 때문에 name 속성은 생략 -->\r\n");
      out.write("                        <td></td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <td>* 이름</td>\r\n");
