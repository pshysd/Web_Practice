 ...
 * Generated at: 2022-10-18 09:21:21 UTC
...
ArrayList<Notice> list = (ArrayList<Notice>) request.getAttribute("list");
      ...
      out.write("\r\n");
      out.write("			<tbody>\r\n");
      out.write("				<!-- 보통 작성일 기준 내림차순, 최신글이 가장 위에 오도록 구현 -->\r\n");
      out.write("\r\n");
      out.write("				<!-- \r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>3</td>\r\n");
      out.write("					<td>test title</td>\r\n");
      out.write("					<td>admin</td>\r\n");
      out.write("					<td>0</td>\r\n");
      out.write("					<td>2021-05-07</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>2</td>\r\n");
      out.write("					<td>test ing</td>\r\n");
      out.write("					<td>admin</td>\r\n");
      out.write("					<td>70</td>\r\n");
      out.write("					<td>2021-04-27</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>1</td>\r\n");
      ...
      out.write("\r\n");
      out.write("				<!-- 리스트가 비어있지 않을 경우 : 조회된 공지사항이 적어도 한 건이라도 있을 경우 -->\r\n");
      out.write("				");
      ...
      out.write("    <script>\r\n");
      out.write("        $(() => {\r\n");
      out.write("            $('.list-area>tbody>tr').click((event) => {\r\n");
      out.write("                // console.log(\"클릭됨\");\r\n");
      out.write("\r\n");
      out.write("                // 클릭했을 때 공지사항 상세보기 페이지를 요청\r\n");
      out.write("                // 단, 해당 공지사항의 게시글 번호를 넘겨야지만 그 게시글만 조회 가능 (pk)\r\n");
      out.write("                // => 해당 클릭된 tr 요소의 자손들 중에서 첫번째 td 영역의 내용\r\n");
      out.write("                const nno = $(event.currentTarget).children().eq(0).text();\r\n");
      out.write("                console.log(nno);\r\n");
      out.write("\r\n");
      out.write("                // 게시글 번호를 넘기면서 url 요청\r\n");
      out.write("                // 요청할url주소?쿼리스트링 => GET방식\r\n");
      out.write("                // 요청할url주소?키=밸류&키=밸류&...\r\n");
      out.write("                // ? 뒤의 내용물 === 쿼리스트링, 직접 만들어서 넘길 예정...\r\n");
      out.write("                // /jsp/detail.no?nno=클릭했을때의 글번호\r\n");
      out.write("                location.href = \"");
      out.print(contextPath);
